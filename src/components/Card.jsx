function Card(props){
    return (
        <div className="flex flex-col sm:flex-row sm:w-1/3">
            <div className="bg-white border-b-4 border-pink-400 rounded-lg flex flex-col items-center p-4">
                <div className="rounded-full text-indigo-600 bg-indigo-50 p-2">
                    <svg className="h-12 w-12 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d={props.path} fill-rule="evenodd" clip-rule="evenodd"/></svg> 
                </div> 
